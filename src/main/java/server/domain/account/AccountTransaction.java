package server.domain.account;

import server.db.ConnectionFactory;
import server.exceptions.GlobalExceptionConfig;
...
public class AccountTransaction extends AccountCheck implements Account {
  ...
  private void executeWithdrawal(Connection connection, int accountNumber, int amount)
      throws SQLException {
  ...
  private void executeDeposit(Connection connection, int accountNumber, int amount)
      throws SQLException {
  ...
  private void executeTransactionQuery(Connection connection, String transactionQuery,
