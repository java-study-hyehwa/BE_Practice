...
public class UserService {
  ...
  private Banker bankerConvertToEntity(Banker bankerDto) {
    return new Banker(bankerDto.banker_uuid(), bankerDto.banker_name(), bankerDto.banker_password(),
        bankerDto.authentication());
  }
  ...
  private Customer customerConvertToEntity(Customer customerDto) {
    return new Customer(customerDto.customer_uuid(), customerDto.customer_name(),
        customerDto.customer_password());
  }
