...
public class TradeDao {
    ...
    public String insertOneTrade(Connection con, Trade trade) throws SQLException {
        boolean result;
        String resultMessage = "";
        PreparedStatement pstmt = null;

        try {
            String sql = Query.TRADE_INSERT_ONE.getQueryString();
    ...
    public ArrayList<Trade> selectAccountTradeHistory(Connection con, String userId, String accountNumber) throws SQLException {
        ArrayList<Trade> tradeList = new ArrayList<>();
        PreparedStatement pstmt = null;
        ResultSet rs = null;
        try {
            String sql = Query.TRADE_SELECT_ACCOUNT_HISTORY.getQueryString();
            pstmt = con.prepareStatement(sql);
