...
public enum Message {
    ...
    ERROR_WRONG_INPUT_WORKNUMBER(() -> "[Error] 화면에 표시된 번호만 입력해주세요."),
    ERROR_WRONG_INPUT_SIGNUP(() -> "[Error] ?을(를) 올바르게 입력해 주세요."),
    ERROR_WRONG_USER_SIGNUP(() -> "[Error] 이미 가입된 회원입니다."),
    ERROR_WRONG_USER_WITHDRAWAL(() -> "[Error] 가입되어 있지 않은 회원입니다."),
